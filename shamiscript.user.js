...
function handleChuusSeenUpdate(){
  document.getElementById("chuusSeen").innerHTML = chuuSeen;
  localStorage.setItem("chuusSeen", chuuSeen);
}
...
function loadSettings() {
  ...
  chuuSeen = getLocalStorageItem("chuusSeen", 0);
  document.getElementById("chuusSeen").innerHTML = chuuSeen;
}
